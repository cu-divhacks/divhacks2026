    ...
    return (
        <footer className="w-full py-10 px-4 flex flex-col items-center justify-center gap-7">
            <a
                ...
                className="font-semibold text-white hover:text-pink-500 underline underline-offset-3 text-sm"
            >
                MLH Code of Conduct
            </a>
            ...
            <div className="flex items-center gap-4 sm:gap-5">
                <a
                    ...
                    aria-label="Email Us"
                    className="bg-white hover:bg-pink-500 hover:text-white text-black w-14 h-14 rounded-2xl flex items-center justify-center hover:opacity-95 transition-opacity"
                >
                    <IoMailSharp size={34} />
                </a>
